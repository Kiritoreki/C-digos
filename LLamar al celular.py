...
uart_port = 0
uart_baute = 115200  # debería ser uart_baudrate
...
# uart setting
uart = machine.UART(uart_port, uart_baute)  # debería ser uart_baudrate
print(os.uname())
...
def http_get():
    ...
    if send_at('AT+HTTPACTION=0', '200', 5000):
        ...
        print("Response is:", rec_buff.decode())
    else:
        print("HTTP GET failed, please check and try again\n")
